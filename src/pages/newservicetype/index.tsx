...
const ServiceType = () => {    
    ...
    const sendInfo = async () => {
        if(title) {
            ...
            let response = await fetch("/api/servicestype", {
                method: 'POST',
                body: JSON.stringify({
                    title: title
                }),
        ...
        <> 
            ...
            {sessionStatus === 'authenticated' &&        
                <div>
                    ...
                    <h1 className={styles.title}>Insira os dados do tipo de serviço</h1>

                    <h2 className={styles.subtitle}>Título do tipo de serviço:</h2>
                    <div className={styles.search}>
                        <input
                            type="text"
                            value={title}
                            onChange={(e)=>setTitle(e.target.value)}
                            placeholder="Digite o nome tipo do serviço" />
                        <KeyboardIcon
                            style={{
